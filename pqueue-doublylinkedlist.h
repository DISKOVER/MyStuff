...
private:
	...
	Node* head;
	int logLen;
	void removeOnlyElement(Node*& head,string& str);
	void removeAtFirst(Node*& head, Node*& node,string& str);
	void removeAtLast(Node*& head, Node*& node,string& str);
	void removeAtMiddle(Node*& head, Node*& node,string& str);
	void removeAccordingly(Node*& head, Node*& node,string& str);
};
